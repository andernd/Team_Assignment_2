...
box1 = ggplot(df2, aes(x=Subscribed, y=Download)) + geom_point()
...
box5 = box4 + scale_x_continuous(limits=c(0,125), breaks=seq(0,125,25)) + scale_y_continuous(limits=c(0,125), breaks=seq(0,125,25))

box5 + facet_wrap( ~ ISP, nrow = 1)
```
...
box5 = box4 + scale_x_continuous(breaks=c(0,30,60,90,120,150),
                                 limits = c(0, 150))
Title = 'Wave is doing best at providing the advertised speeds'
