...
box2 = box1 + geom_point() + facet_wrap( ~ ISP, nrow = 2) + theme(axis.text.x = element_text(angle = 45, hjust = .7, vjust = .7), axis.title.y = element_text(vjust = 3), axis.title.x = element_text(vjust = -0.5)) +labs(title = "Download Speed in Relation To Subscribed Speed", x = "Subscribed Speed", y = "Download Speed")

box3 = box2 + scale_x_discrete(limits = c('5.0 - 9Mbps','10 - 24 Mbps','25 - 49 Mbps','50 - 99 Mbps', '100 - 125 Mbps','Above 250 Mbps'))
...
box2 = box1 + geom_point() + facet_wrap( ~ ISP, nrow = 2) + theme(axis.text.x = element_text(angle = 45, hjust = .7, vjust = .7), axis.title.y = element_text(vjust = 3), axis.title.x = element_text(vjust = -0.5)) +labs(title = "Upload Speed in Relation To Subscribed Speed", x = "Subscribed Speed", y = "Upload Speed")
